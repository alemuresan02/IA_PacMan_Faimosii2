...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        " Constructorul clasei. Inițializează valorile Q cu ajutorul unui Counter de la util (care funcționează ca un dicționar cu valori implicite 0). "
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def final(self, state):
        ...
        if self.episodesSoFar == self.numTraining:
            ...
            print("Training completed after {} episodes.".format(self.numTraining))
